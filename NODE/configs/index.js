...
//inserir um array para ler temperatura E umidade
var array=temp.split(",");
    ...
    io.sockets.emit('temp', {date: data, time: hora, temp:array[0], umid:array[1]});//temp:temp}); //Emite o objeto temp, com os atributos date, time e temp
});
